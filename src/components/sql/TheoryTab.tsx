...
function SectionTitle({ icon, title, subtitle }) {
  return (
    <div className="flex items-start gap-3">
      <div className="p-2 rounded-xl bg-white/50 dark:bg-white/10 ring-1 ring-primary/20 backdrop-blur-sm">
        {React.cloneElement(icon as any, {
          className: ((icon as any).props.className ?? "") +
            " drop-shadow-[0_0_6px_rgba(0,0,0,0.18)] dark:drop-shadow-[0_0_4px_rgba(255,255,255,0.25)]"
        })}
      </div>
      <div>
