                ...
                <section className="space-y-4 sm:space-y-6">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-slate-600 dark:text-slate-300 text-sm sm:text-base">
                        <strong className="text-slate-900 dark:text-white/90">Promaster Development</strong> — начинающий разработчик, создающий сайты, игры и чат-ботов для Telegram. Люблю экспериментировать с идеями, учусь новым технологиям и превращаю код в что-то живое и интересное. с упором на понятные примеры и практику.
                      </p>
                    </div>
                  </motion.div>
